...
local ft = TukuiCF["media"].font -- Map font
...
tinymap:SetScript("OnEvent", function(self, event, addon)
	...
	BattlefieldMinimap:SetScript("OnShow", function(self)
		-- show holder
		tinymap:Show()
		Tukui.Kill(BattlefieldMinimapCorner)
		Tukui.Kill(BattlefieldMinimapBackground)
		Tukui.Kill(BattlefieldMinimapTab)
		Tukui.Kill(BattlefieldMinimapTabLeft)
		Tukui.Kill(BattlefieldMinimapTabMiddle)
		Tukui.Kill(BattlefieldMinimapTabRight)
