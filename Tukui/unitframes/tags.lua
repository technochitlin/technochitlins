...
oUF.TagEvents['Tukui:nameshort'] = 'UNIT_NAME_UPDATE UNIT_HEALTH'
oUF.Tags['Tukui:nameshort'] = function(unit)
	local name = UnitName(unit)
	return utf8sub(name, 10, false)
end

oUF.TagEvents['Tukui:namemedium'] = 'UNIT_NAME_UPDATE UNIT_HEALTH'
oUF.Tags['Tukui:namemedium'] = function(unit)
	local name = UnitName(unit)
	return utf8sub(name, 15, true)
end

oUF.TagEvents['Tukui:namelong'] = 'UNIT_NAME_UPDATE UNIT_HEALTH'
